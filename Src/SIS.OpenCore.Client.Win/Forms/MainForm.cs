...
using SIS.OpenCore.Client.Win.Forms.S.Pay.MT202;
...
namespace SIS.OpenCore.Client.Win
{
    public partial class MainForm : Form
    {
        ...
        /*
        NodeMouseDoubleClick event instead, 
        which uses TreeNodeMouseClickEventArgs
        */
        // private void treeMenu_NodeMouseDoubleClick(object sender, TreeNodeMouseClickEventArgs e)
        // {
        //     // if (e.Node.Tag == "MT202_New")
        //     // {
        //     //     if (_newMt202form is null)
        //     //     {
        //     //         _newMt202form = new MT202NewForm();
        //     //         //_newMt202form.MdiParent = this;                    
        //     //     }
        //     //     _newMt202form.Show();
        //     // }
        // }
        ...
        private void MenuItem_MT202_New_Click(object sender, EventArgs e)
        {
            var newMt202form = new MT202NewForm();
            newMt202form.MdiParent = this;
            newMt202form.Show();
        }
    }
}
